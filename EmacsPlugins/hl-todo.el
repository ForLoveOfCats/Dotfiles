...
(defcustom hl-todo-keyword-faces
  '(("HOLD" . "#d0bf8f")
    ("TODO" . "#ff5959") ;Modified, used to be #cc9393
    ("NEXT" . "#dca3a3")
    ("THEM" . "#dc8cc3")
    ("PROG" . "#7cb8bb")
    ("OKAY" . "#7cb8bb")
    ...
    ("FAIL" . "#8c5353")
    ("DONE" . "#afd8af")
    ("NOTE"   . "#4c96ff") ;Modified, used to be d0bf8f
    ("KLUDGE" . "#ff5959") ;Modified, used to be d0bf8f
    ("HACK"   . "#ff5959") ;Modified, used to be d0bf8f
    ("TEMP"   . "#d0bf8f")
    ("FIXME"  . "#ff5959") ;Modified, used to be cc9393
    ("XXX"    . "#cc9393")
    ("XXXX"   . "#cc9393")
    ("???"    . "#cc9393"))
